  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/lib/executeOrder.ts',
        'src/lib/observability.ts',
        'src/lib/historicalTicks.ts',
        'src/lib/counterfactual.ts',
        'src/lib/riskEngine.ts',
        'src/lib/newsParser.ts',
        'src/lib/analyticsDispatch.ts',
        'src/lib/venueQuoteFanout.ts',
        'src/lib/workerClient.ts',
        'src/lib/keyDisplay.ts',
        'src/lib/strategyMockTicks.ts',
        'src/lib/priceSnapshot.ts',
        'src/lib/alertNotifications.ts',
        'src/lib/appSections.ts',
        'src/lib/chartFormatters.ts',
      ],
